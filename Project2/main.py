...
if __name__ == "__main__":
    ...
    # grid, start, goal = load_map('maps/test_map_boundary_same.csv')
    # grid, start, goal = load_map('maps/test_map_boundary_edge.csv')
    # grid, start, goal = load_map('maps/test_map_no_Valid_path.csv')
